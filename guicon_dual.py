...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.motor1_pos_value = QLineEdit(str(self.dnx.get_position(DXL1_ID)/10))
        ...
        self.motor1_voltage_value = QLineEdit(str(self.dnx.get_voltage(DXL1_ID)))
        ...
        motor1_box.addLayout(motor1_voltage_box)
        ...
        motor2_box.addLayout(motor2_voltage_box)
    ...
    def update_values(self):
        ...
        self.motor1_voltage_value.setText(str(self.dnx.get_voltage(DXL1_ID)/10))
        ...
        self.motor2_voltage_value.setText(str(self.dnx.get_voltage(DXL2_ID)/10))
